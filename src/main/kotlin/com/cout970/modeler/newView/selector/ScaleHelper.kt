...
import com.cout970.modeler.view.controller.selection.IScalable
...
object ScaleHelper {
    ...
    fun applyScale(model: Model, scene: Scene, obj: IScalable, input: IInput,
        ...
        return obj.applyScale(offset, model)
    }
