...
class GuiResources {
    ...
    fun reload(loader: ResourceLoader) {
        ...
        orientationCubeMesh = ModelImporters.objImporter.importAsMesh(
            "assets/models/orientation_cube.obj".fromClasspath(), false
        )
        lightMesh = ModelImporters.objImporter.importAsMesh("assets/models/light.obj".fromClasspath(), true)
        translationArrow = ModelImporters.objImporter.importAsMesh(
            "assets/models/translation_x.obj".fromClasspath(), true
        )
